        ...
        {(drops || []).map((d: any) => (
          ...
          >
            <div
              ...
              style={{ background: d.background_color || "#ff5a36" }}
            />
            ...
            <div className="flex items-center gap-3 text-xs">
              <span
                className={`px-2 py-1 rounded-full font-medium ${
                  d.active ? "bg-[#0f9b81]/15 text-[#0f9b81]" : "bg-[#1a1a1a]/10 text-[#502e23]/70"
                }`}
              >
                {d.active ? "ενεργό" : "ανενεργό"}
              </span>
              <span className="text-[#502e23]/70">{(d.product_ids || []).length} προϊόντα</span>
